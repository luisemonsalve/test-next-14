...
export default {
  ...
  fields: [
    ...
    },
    {
      ...
      hidden: ({ parent }) => !parent?.type || parent.type == "nested",
    },
    {
      name: "type",
      title: "Tipo",
    ...
    /* Simple y porcentaje */
    {
      ...
      hidden: ({ parent }) =>
        !parent?.type ||
        (parent.type !== "simple" && parent.type !== "percentage"),
    },
    {
      name: "unity",
    ...
    /* Porcentaje */
    {
      ...
      type: "string",
      hidden: ({ parent }) => !parent?.type || parent.type !== "percentage",
    },
    {
      name: "totalTitle",
    ...
    /* Checklist */
    {
      ...
      hidden: ({ parent }) => !parent?.type || parent.type !== "checklist",
    },
    ...
    /* Múltiple */
    {
      ...
      hidden: ({ parent }) => !parent?.type || parent.type !== "multiple",
    },
    /* Anidado */
    {
      name: "nestedItems",
